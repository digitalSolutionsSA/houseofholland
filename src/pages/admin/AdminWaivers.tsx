...
import { downloadConsentForm } from '../../lib/downloadConsentForm'
...
export function AdminWaivers() {
  ...
  function downloadWaiver(w: WaiverRow) {
    const apptDate = new Date(w.appointment_at).toLocaleDateString('en-US', {
      weekday: 'long', month: 'long', day: 'numeric', year: 'numeric',
    })
    downloadConsentForm(w.consent!, `Appointment: ${apptDate}`)
  }
